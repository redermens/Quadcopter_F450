...
#define SDIO_INTPRIO_CFG 1,0

	#define SDIO_D0_PIN 		GPIOC,GPIO_Pin_8
#define SDIO_D0_PIN_S 	GPIOC,GPIO_PinSource8
#define SDIO_D1_PIN 		GPIOC,GPIO_Pin_9
#define SDIO_D1_PIN_S 	GPIOC,GPIO_PinSource9
#define SDIO_D2_PIN 		GPIOC,GPIO_Pin_10
#define SDIO_D2_PIN_S	 	GPIOC,GPIO_PinSource10
#define SDIO_D3_PIN 		GPIOC,GPIO_Pin_11
#define SDIO_D3_PIN_S		GPIOC,GPIO_PinSource11
#define SDIO_SCK_PIN 		GPIOC,GPIO_Pin_12
#define SDIO_SCK_PIN_S 	GPIOC,GPIO_PinSource12
#define SDIO_CMD_PIN 		GPIOD,GPIO_Pin_2
#define SDIO_CMD_PIN_S 	GPIOD,GPIO_PinSource2
...
卡,可能也会出错,出错就请降低时钟
*/
#define SDIO_INIT_CLK_DIV        0x76 		//SDIO初始化频率，最大400Kh  //0x76
#define SDIO_TRANSFER_CLK_DIV    0x02		//SDIO传输频率,该值太小可能会导致读写文件出错 0x00
...
SD_Error SD_Init(int PrePriority,int SubPriority);
...
#define SDIO_STD_CAPACITY_SD_CARD_V1_1             ((u32)0x00000000)//支持的SD卡定义
...
#define SD_OCR_ADDR_OUT_OF_RANGE        ((u32)0x80000000)		//Mask for errors Card Status R1 (OCR Register)
...
#define SD_R6_GENERAL_UNKNOWN_ERROR     ((u32)0x00002000)	//Masks for R6 Response
...
#define SD_MAX_VOLT_TRIAL               ((u32)0x0000FFFF)	//0x0000FFFF
...
#define SD_CCCC_LOCK_UNLOCK             ((u32)0x00000080)//Command Class Supported
#define SD_CCCC_WRITE_PROT              ((u32)0x00000040)
#define SD_CCCC_ERASE                   ((u32)0x00000020)
#define SDIO_SEND_IF_COND               ((u32)0x00000008)	//CMD8
